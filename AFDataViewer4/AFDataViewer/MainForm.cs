...
//  Version 4:
//
//      Enable user-requested cancellation of data retrievals that
//      are taking too long.  
//
//--------------------------------------------------------------------------
...
namespace AFDataViewer
{
    public partial class MainForm : Form
    {
        ...
        private void btnAbout_Click(object sender, EventArgs e)
        {
            ...
            sb.AppendLine("Incorporates a Cancel feature for the Async data retrieval calls.  This introduces a whole new set of concerns.");
            sb.AppendLine();
            sb.AppendLine("A cancellation request will be ignored for a non-async call such as GetValues.");
            sb.AppendLine();
            sb.AppendLine("The Cancel button is created dynamically and will not be available in the Form Editor.");
            MessageBox.Show(this, sb.ToString(), "About Version 4", MessageBoxButtons.OK);
        }
        ...
        // NEW to Version 4
        // Cancellation will throw an exception so we sniff any exceptions to decide if we
        // can safely ignore the ones caused by a user cancellation request.
