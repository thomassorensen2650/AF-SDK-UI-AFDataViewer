...
//  Version 2:
//
//      Validation of user inputs is done BEFORE "Get Data" is clicked.
//      In fact, btnGetData is not enabled UNLESS data is validated.
//      This requires a new CheckUserInputsState() method to be called 
//      after each input.
//
//      Right and/or bottom anchoring for the grid and tree view.
//      Now as you resize the form, the grid will grow or shrink.
//      While anchoring could be set in the property sheet, it sometimes gets
//      messy in the editor, so we will set at runtime.
//
//--------------------------------------------------------------------------
...
namespace AFDataViewer
{
    public partial class MainForm : Form
    {
        ...
        private void btnAbout_Click(object sender, EventArgs e)
        {
            ...
            sb.AppendLine("Validation of user inputs is done before you are allowed to click the 'Get Data' button.");
            sb.AppendLine();
            sb.AppendLine("There is bottom and right anchoring of some controls.  As you resize the form, notice that the grid grows or shrinks.");
            MessageBox.Show(this, sb.ToString(), "About Version 2", MessageBoxButtons.OK);
        }
        ...
        private void btnGetData_Click(object sender, EventArgs e)
        {
            ...
            // No need to call ValidateUserInputs as in Version 1.
            // btnGetData will not be enabled UNLESS all user picks pass validation first.
